    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">About Libris Haven</h3>
            <p className="text-sm">
              Your sanctuary for exceptional books, where every page turns into
              an adventure.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-sm text-center">
          © 2024 Libris Haven. All rights reserved.
        </div>
      </div>
    </footer>
  );
